...
export default function FireStoreTest() {
    ...
    useEffect(()=>{
        ...
        async function getUserData () {
            ...
            const querySnapshot = await getDoc(doc(db,'userList','i3cAocvmIfVzLFRbsL85'));
    ...
    return (
        <div>
            <h3>FireStore의 값을 추가, 가져오는 것 확인</h3>
            <p>users 컬렉션 확인</p>
            ...
            <button onClick={addDocData}>Firestore에 값 추가</button>
            <br />
            ...
            <button onClick={onSearch}>Search Last</button>
            ...
            <br />
            {
                users && users.map((user) => (
                    <div>
                        {/* <p>{user.id}, {user.first}, {user.born}</p> */}
                        ...
                        {/* <button onClick={ updateData }>First Edit</button> */}
                        {/* 매개변수를 전달해서 사용해주기때문에 화살표함수로 작성 */}
